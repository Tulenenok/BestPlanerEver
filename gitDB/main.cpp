...
int main()
{
	...
	BestPlanDB obj;
    //Dobavlenie novogo usera
    //int a= obj.Insert_New_User("dfsf","sdfd","fdfdsail.ru");
    //Dobavlenie default tasks
// vector<string> arr;
//   string str="";
//    for(int i=0;i<8;++i){arr.push_back(str);}
//   int a=obj.Insert_New_Task(1,arr);
// Dobavlenie opredelennoi taski
//int a=obj.New_Task(1,1,"Play computer gahems");
// func Update rabotaet analogichno
// zamena na "" tipo udalenie
//int a=obj.Delete_Task(1,1);
//vse taski po id usera
//vector<string> arr;
//arr=obj.get_all_tasks(1);
//for(const auto& elem:arr){cout<<elem<<" ";}
// taski po loginu i parolu
vector<pair<int, vector<string>>>arr =obj.login("Petr","123");
	return 0;
}
