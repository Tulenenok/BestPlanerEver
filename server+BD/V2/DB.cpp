...
MYSQL* BestPlanDB:: MakeConnection() const
{
	...
	conn = mysql_real_connect(conn, "localhost", "root", "newpassword", "BD", 3306, NULL, 0);
	return conn;
}
...
int BestPlanDB::get_id(string user_login,string user_mail,string user_password)
{
    ...
    {  string  query ="SELECT UserID FROM `User` WHERE (Login, Password, Email) VALUES (NULL, ";
